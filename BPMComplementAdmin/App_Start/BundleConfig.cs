...
namespace Ultimus.AuditManager.Admin
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/Ultimus-AuditConfiguration")
                .Include("~/Ultimus.Framework/Ultimus.API.AuditConfiguration.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Ultimus-WebAplication")
    .Include("~/Ultimus.Framework/Ultimus.API.WebAplication.js"));
